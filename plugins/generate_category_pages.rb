  ...
  class CategoryPages < Generator
    ...
    def paginate(site, page)
      ...
      (1..pages).each do |num_page|
        ...
        pager = CategoryPager.new(page.data['category'], site.config, num_page, category_posts, page_dir+'/', "/#{page.data['category'].downcase}/", pages)
    ...
    if pager['previous_page'] || pager['next_page']
      ...
      if pager['previous_page']
        ...
        if pager['previous_page'] == 1
          ...
          html << "<div class=\"previous\"><a href=\"#{pager['previous_page']}\">&laquo; Newer posts</a></div>"
        end

      end

      if pager['next_page']
        html << "<div class=\"next\"><a href=\"#{pager['next_page']}\">Older posts &raquo;</a></div>"
      end
